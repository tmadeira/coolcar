...
public class Veiculo {
	...
	public Veiculo(String tipoDoVeiculo, String chassi, String placa, 
			       int km, int ano, String status, int id_func, int id_modelo, int filial_alojada,
	...
	public void setTipoDoVeiculo(String tipoDoVeiculo){this.tipoDoVeiculo = tipoDoVeiculo;}
	public void setChassi(String chassi){this.chassi = chassi;}
	public void setPlaca(String placa){this.placa = placa;}
	public void setKm(int km){this.km = km;}
	public void setAno(int ano){this.ano = ano;}
	public void setStatus(String status){this.status = status;}
	public void setIdFunc(int id_func){this.id_func = id_func;}
	public void setIdModelo(int id_modelo){this.id_modelo = id_modelo;}
	public void setFilialAlojada(int filial_alojada){this.filial_alojada = filial_alojada;}
