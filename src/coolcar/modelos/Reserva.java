...
public class Reserva {
	...
	public Reserva(int id_cliente, int id_reserva, int id_modelo, int id_filial_retirada, int id_acessorios, int id_filial_devolucao,
				   float valor, Date dt_fim_reserva, Date dt_inicio_reserva) {
