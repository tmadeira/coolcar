...
public class CaracteristicasCarro {
	...
	public void setArCond(boolean ar){this.ar_condicionado = ar;}
	public void setCambAuto(boolean ca){this.cambio_automatico = ca;}
	public void setDirHid(boolean di){this.direcao_hidraulica = di;}

	public boolean getArCond(){return this.ar_condicionado;}
	public boolean getCambAuto(){return this.cambio_automatico;}
	public boolean getDirHid(){return this.direcao_hidraulica;}
}
