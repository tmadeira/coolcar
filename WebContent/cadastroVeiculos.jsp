 ...
 <form class="form-horizontal">
  <fieldset>
   ...
   <div class="form-group">
    ...
    <div class="col-md-4">
     <input id="textinput" name="textinput" type="text"
      placeholder="Sem pontos" class="form-control input-md" required="">
   ...
   <div class="form-group">
    ...
    <div class="col-md-2">
     <input id="textinput" name="textinput" type="text"
      placeholder="YYYY" class="form-control input-md" required="">
   ...
   <div class="form-group">
    ...
    <div class="col-md-4">
     <input id="textinput" name="textinput" type="text"
      placeholder="Nome do modelo" class="form-control input-md">
   ...
   <div class="form-group">
    ...
    <div class="col-md-2">
     <input id="textinput" name="textinput" type="text"
      placeholder="preço da diária" class="form-control input-md">
   ...
   <div class="form-group">
    ...
    <div class="col-md-4">
     <input id="textinput" name="textinput" type="text"
      placeholder="Tipo de carro" class="form-control input-md">
   ...
   <!-- Text input-->
   <div class="form-group">
    <label class="col-md-4 control-label" for="">Tamanho do
     Porta Malas</label>
    <div class="col-md-1">
    ...
    <div class="col-md-4">
     <div class="checkbox">
      <label for="checkboxes-0"> <input type="checkbox"
       name="checkboxes" id="checkboxes-0" value="1"> Ar
       Condicionado
      </label>
     </div>
     <div class="checkbox">
      <label for="checkboxes-1"> <input type="checkbox"
       name="checkboxes" id="checkboxes-1" value="2"> Direção
       Hidráulica
      </label>
     </div>
     <div class="checkbox">
      <label for="checkboxes-2"> <input type="checkbox"
       name="checkboxes" id="checkboxes-2" value="3"> Câmbio
       Automático
      </label>
     </div>
    </div>
   ...
   <!-- Textarea -->
   <div class="form-group">
    <label class="col-md-4 control-label" for="textarea">Descrição
     Geral</label>
    <div class="col-md-4">
   ...
   <!-- Text input-->
   <div class="form-group">
    <label class="col-md-4 control-label" for="textinput">Tamanho
     do Tanque</label>
    <div class="col-md-1">
     <input id="textinput" name="textinput" type="text" placeholder=""
      class="form-control input-md">
   ...
   <div class="form-group">
    ...
    <div class="col-md-4">
     <button id="singlebutton" name="singlebutton" class="btn btn-info">Cadastrar
      Veículo</button>
    </div>
   </div>
