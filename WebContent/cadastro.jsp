...
<div class="container">
 <h2>Crie sua conta</h2>
	 ...
	 <form class="form-horizontal" role="form" method="post" action="CadastroServlet">
	 
	 	<div class="form-group">
		   <label class="col-md-4 control-label" for="nome">*Tipo de pessoa:</label>
		   <div class="col-md-5">
		...
		<div class="form-group" id="dtNasc">
		   <label class="col-md-4 control-label" for="data-de-nascimento">*Data de Nascimento:</label>
		   		   <div class="col-md-2">
	    <input type="date" class="form-control" name="dtNascimento" id="data-de-nascimento" required>
	    </div></div>
	    	    
		<div class="form-group" id="cpf">
		   <label class="col-md-4 control-label" for="cpf">*CPF:</label>
		   		   <div class="col-md-2">
		<input type="text" class="form-control" name="cpf" onblur="javascript: validarCPF(this.value);" onkeypress="javascript: mascara(this, cpf_mask);"  maxlength="14" placeholder="11122233344" id="cpf" required>   
	    </div></div>
	    
	    <div class="form-group" id="cnpj">
		   <label class="col-md-4 control-label" for="cnpj">*CNPJ:</label>
		   		   <div class="col-md-2">
		<input type="text" class="form-control" name="cnpj" placeholder="11122233344" id="cnpj">   
	    </div></div>
	    
		<div class="form-group">
		   <label class="col-md-4 control-label" for="telefone">Telefone:</label>
		   <div class="col-md-2">
	    <input type="text" class="form-control" name="telefone" placeholder="1144448888" id="telefone">
	    </div></div>
	    
		<div class="form-group">
		   <label class="col-md-4 control-label" for="celular">*Celular:</label>
		   <div class="col-md-2">
	    <input type="text" class="form-control" name="celular" placeholder="11333335555" id="celular" required>
	    </div></div>
	    
	    <div class="form-group">
		   <label class="col-md-4 control-label" for="logradouro">*Logradouro:</label>
		   <div class="col-md-5">
	    <input type="text" class="form-control" name="logradouro" placeholder="Rua" id="logradouro" required>
	    </div></div>
	    
	    <div class="form-group">
		   <label class="col-md-4 control-label" for="numero">*Número:</label>
		   <div class="col-md-1">
	    <input type="text" class="form-control" name="numero" placeholder="55" id="numero" required>
	    </div></div>
	    
	    <div class="form-group">
		   <label class="col-md-4 control-label" for="complemento">Complemento:</label>
		   <div class="col-md-2">
	    <input type="text" class="form-control" name="complemento" placeholder="Bloco 1 Ap 2" id="complemento">
	    </div></div>
	    
	    <div class="form-group">
		   <label class="col-md-4 control-label" for="cep">*CEP:</label>
		   <div class="col-md-2">
	    <input type="text" class="form-control" name="cep" placeholder="55555333" id="cep" required>
	    </div></div>
	    
	    <div class="form-group">
		   <label class="col-md-4 control-label" for="cidade">*Cidade:</label>
		   <div class="col-md-5">
	    <input type="text" class="form-control" name="cidade" placeholder="São Paulo" id="cidade" required>
	    </div></div>
	    
	    <div class="form-group">
		   <label class="col-md-4 control-label" for="estado">*Estado:</label>
		   <div class="col-md-1">
	    <input type="text" style="text-transform: uppercase" maxlength="2" class="form-control" name="estado" placeholder="SP" id="estado" required>
	    </div></div>
	 ...
	 <h3> Dados de acesso</h3>
	    ...
	    <div class="form-group">
		   <label class="col-md-4 control-label" for="email">*Confirme seu email:</label>
		   <div class="col-md-5">
	    <input type="email" class="form-control" name="confirmacaoDeEmail" placeholder="maria@coolcar.com" id="confirmacaoDeEmail" required>
		 ...
		 <div class="form-group">
		    ...
		    <div class="col-md-4">
		 	<button id="button" type="submit" class="btn btn-default">Criar Conta</button>
		 </div></div>
	</form>
</div>
